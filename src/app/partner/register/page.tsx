            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-1">
                  ...
                  <input type="text" required value={formData.firstName || ''} onChange={e => setFormData({...formData, firstName: e.target.value})} className={inputClass} placeholder="First" autoComplete="given-name" />
                </div>
                <div className="space-y-1">
                  <label className={labelClass}>Last Name *</label>
                  <input type="text" required value={formData.lastName || ''} onChange={e => setFormData({...formData, lastName: e.target.value})} className={inputClass} placeholder="Last" autoComplete="family-name" />
                </div>
                <div className="space-y-1">
                  <label htmlFor="partner-phone" className={labelClass}>Phone *</label>
                  <label htmlFor="partner-phone" className="flex cursor-text group">
                    ...
                    <input id="partner-phone" type="tel" required value={formData.phone || ''} onChange={(e) => {
