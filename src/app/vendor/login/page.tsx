...
import { Eye, EyeOff, LogIn, Loader2, Car, ArrowLeft } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.success && response.data) {
        ...
        localStorage.setItem(USER_KEYS.vendor, JSON.stringify(vendor));
    ...
    <div className="min-h-screen bg-[#0D0D0D] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-white mb-3">Vendor Login</h1>
          <p className="text-neutral-400">Sign in to manage your fleet</p>
        </div>
